...
/// Parse a simple ISO 8601 UTC timestamp (YYYY-MM-DDTHH:MM:SSZ or YYYY-MM-DDTHH:MM:SS.ssssss±hh:mm) to Unix epoch seconds
/// Returns None if the format is invalid
/// Note: this only return to second-precision and ignores timezone offsets
