...
/// Parse a simple ISO 8601 UTC timestamp (YYYY-MM-DDTHH:MM:SSZ) to Unix epoch seconds
/// Returns None if the format is invalid
fn parse_iso8601_utc(timestamp: &str) -> Option<u64> {
    // Expected format: 2023-01-01T12:00:00Z
...
/quux/quuz|5|500";
    ...
    fn from_jump() {
        ...
        let quux_time = "2023-01-03T12:00:00Z";
